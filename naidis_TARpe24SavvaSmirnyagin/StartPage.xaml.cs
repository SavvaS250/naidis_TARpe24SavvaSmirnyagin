...
public partial class StartPage : ContentPage
{
    ...
    public List<ContentPage> Lehed = new List<ContentPage>() { new TextPage(), new FigurePage(), new ValgusFoor(), new DateTime_Page()
        ...
        , new TripsTrapsTrull(), new Table_Page(), new List_Page(), new Euroopa_Page(), new CarouselPage(), new MainPage()};
    public List<string> LeheNimed = new List<string>() { "Tekst", "Kujund", "Valgusfoor", "DateTime", "Slider/Stepper", "Rgb slider", "Lumememm", "Pop up",
          "Mõistatuste leht", "Picker image grid", "Trips-Traps-Trull", "Table page", "List page", "Euroopa riikide rakendus", "Carousel page", "Memo mäng"};
    public StartPage()
    {
        //Title = "Avaleht";
