...
namespace naidis_TARpe24SavvaSmirnyagin 
{
    ...
    public class Telefon
    {
        ...
        public string Pilt { get; set; } // Hoiab pildi nime vıi seadme failiteed
    }
    ...
    public partial class List_Page : ContentPage
    {
        ...
        public List_Page()
        {
            ...
            entryHind = new Entry { Placeholder = "Hind (t‰isarv)", Keyboard = Keyboard.Numeric };
            ...
            list.ItemTemplate = new DataTemplate(() =>
            {
                ...
                lblHind.SetBinding(Label.TextProperty, new Binding("Hind", stringFormat: "{0} Ä"));
        ...
        // --- S‹NDMUSTE T÷÷TLEJAD (Event Handlers) ---
        ...
        private async void BtnValiPilt_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                if (photo != null)
                {
                    valitudPildiTee = photo.FullPath; // J‰tame asukoha meelde
            ...
            {
                await DisplayAlert("Viga", "Pildi valimine ebaınnestus: " + ex.Message, "OK");
            }
        }
        ...
        private void Lisa_Clicked(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(entryNimetus.Text) && !string.IsNullOrWhiteSpace(entryTootja.Text))
            {
                ...
                string pildiNimi = string.IsNullOrWhiteSpace(valitudPildiTee) ? "default_phone.g" : valitudPildiTee;
                ...
                // Puhastame v‰ljad uue sisestuse jaoks
                entryNimetus.Text = "";
                entryTootja.Text = "";
                entryHind.Text = "";

                // L‰htestame pildi valiku oleku
                valitudPildiTee = "";
            ...
            {
                DisplayAlert("Viga", "Palun t‰ida v‰hemalt mudeli ja tootja v‰ljad!", "OK");
            }
        }
